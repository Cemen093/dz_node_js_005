...
db.collection('manufacturer').insertMany([{name: "manufacturer_1"}, {name: "manufacturer_2"}, {name: "manufacturer_3"}])
db.collection('category').insertMany([{name: "food"}, {name: "electronics"}, {name: "tool"},{name: "furniture"}])
